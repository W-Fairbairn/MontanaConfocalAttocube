...
qmm = QuantumMachinesManager(host=qop_ip, port=opx_port, cluster_name=cluster_name, octave_calibration_db_path=calibration_db_dir,)
...
if check_down_converters:
    ...
    if check_down_converter_2:
        ...
        with program() as hello_octave_readout_2:
            ...
            measure("readout", elements[0], raw_ADC_2)
            with stream_processing():
