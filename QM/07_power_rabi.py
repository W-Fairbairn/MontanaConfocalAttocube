...
rabi_frequency = 6.25 * u.MHz
ODMR_peak_freq = -82.5 * u.MHz
...
with program() as power_rabi:
    ...
    with for_(n, 0, n < n_avg, n + 1):
        with for_(*from_array(a, a_vec)):
            ...
            play("x90" * amp(a), "NV")  # 'a' is a pre-factor to the amplitude defined in the config ("mw_amp_NV")
...
if simulate:
    ...
    while results.is_processing():
        ...
        # Plot data
        plt.cla()
        plt.scatter(a_vec * x180_amp_NV, counts / counts_ref, label="norm. photon counts")
